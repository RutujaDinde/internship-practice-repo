...
document.addEventListener("DOMContentLoaded", () => {
    ...
    if (editProfile) {
        editProfile.addEventListener( "submit", updateAdminProfile  );
    }

});

const DEFAULT_IMAGE =  "/static/uploads/default.png";
...
async function loadAdminProfile() {
    ...
    try {
        ...
        if ( admin.Profile_Image &&admin.Profile_Image.trim() !== "" ) {

            imageUrl =  "/static/uploads/" +  admin.Profile_Image +  "?t=" +  Date.now();
        ...
        if (editProfilePreview) {
            ...
            editProfilePreview.src = imageUrl;

            editProfilePreview.onerror = function () {
                this.onerror = null;
                this.src = DEFAULT_IMAGE;
            };
